...
export const FEATURE_ICONS: Record<string, ComponentType<{ className?: string }>> = {
  ...
  safe: Lock,
  loungeaccess: Sofa,
  butlerservice: UserCheck,
  privateterrace: Fence,
  balcony: Maximize,
  kitchen: ChefHat,
  jacuzzi: Waves,
};
...
export const ROOMS: RoomDetail[] = [
  {
    ...
    features: ['wifi', 'coffee', 'tv', 'bath', 'airconditioning', 'safe'],
    specs: [
  ...
  },
  {
    ...
    features: ['wifi', 'coffee', 'tv', 'bath', 'guests', 'minibar', 'loungeaccess', 'airconditioning'],
    specs: [
      { icon: BedDouble, label: 'Bed', value: 'King Size' },
  ...
  },
  {
    ...
    features: ['wifi', 'coffee', 'tv', 'bath', 'guests', 'size', 'minibar', 'roomservice', 'butlerservice', 'jacuzzi', 'privateterrace'],
    specs: [
